...
**объектная модель, коллекции, система ввода-вывода, работа с файлами, сериализация, работа с XML, JSON, SQL, персистентность в базу данных (PostgreSQL), сервлеты, HTML/JSP/JSTL, веб-контейнер Tomcat, модульные тесты JUnit, java.ru.javawebinar.basejava.util.Logging, система контроля версий Git.**
...
### Занятие 12
 - [java.ru.javawebinar.basejava.util.concurrent](lesson/lesson12.md#javautilconcurrent)
